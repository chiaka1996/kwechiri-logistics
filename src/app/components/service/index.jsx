...
export default function Service() {
    return (
    //     css in global css
      <section className="py-[10rem] max-sm:py-[5rem] text-[1.6rem] max-sm:text-mobileText text-[#606161] leading-[2.5rem] bg-primary_background" id="service"> 
        <div className="container gridStyle gap-[5rem] max-sm:gap-[3rem]">
            <div>
            <h1 className="bg-primary_color mb-[3rem] max-sm:mb-[1.5rem] rounded-[10px] text-[#fff] font-[500] w-[15rem] max-sm:w-[13rem] h-[45px] px-[2rem] flex items-center justify-center">OUR SERVICES</h1>
            <h2 className="text-secondary_color text-[5rem] max-sm:text-[3rem] font-[700] leading-[7rem] max-sm:leading-[4.5rem]">Logistics services tailored to your needs.</h2>
            </div>
